...
function options.f_keyDefault()
	...
	for i = 1, #config.KeyConfig do
		if i == 1 then
			btns = {up = 'w', down = 's', left = 'a', right = 'd', a = 'j', b = 'k', c = 'l', x = 'u', y = 'i', z = 'o', start = 'h', d = 'p', w = 'SEMICOLON', menu = 'y'}
		elseif i == 2 then
			btns = {up = 'UP', down = 'DOWN', left = 'LEFT', right = 'RIGHT', a = 'KP_1', b = 'KP_2', c = 'KP_3', x = 'KP_4', y = 'KP_5', z = 'KP_6', start = 'KP_0', d = 'KP_PLUS', w = 'KP_ENTER', menu = 'KP_PERIOD'}
		else
			btns = {}
		end
	...
	btns = {up = '10', down = '12', left = '13', right = '11', a = '0', b = '5', c = '-12', x = '2', y = '3', z = '1', start = '7', d = '4', w = '-10', menu = '6'}
